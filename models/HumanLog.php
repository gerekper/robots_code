 ...
 * This is a gerekper.robots[human_log] for OctoberCMS
 *
 * @category   Gerekper+ Addons | Toolbox Plugin File
 * @package    Devnull.robots.models.human_log | Octobercms
...
class HumanLog extends Model
{
    //----------------------------------------------------------------------//
    //	Constant Functions - Start
    //----------------------------------------------------------------------//

    public $table           =   'gp_robots_human_log';
    public static $_table   =   'gp_robots_human_log';
