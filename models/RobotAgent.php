 ...
 * This is a gerekper.robots[robots_agent] for OctoberCMS
 *
 * @category   Gerekper+ Addons | Toolbox Plugin File
 * @package    Devnull.robots.models.robots_agent | Octobercms
...
class RobotAgent extends Model
{
    ...
    public $table           =   'gp_robots_robot_agent';
    public static $_table   =   'gp_robots_robot_agent';
